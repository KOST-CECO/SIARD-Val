...
public class ValidationLconstraintException extends SIARDValException
{
	...
	public ValidationLconstraintException()
	{
		super();
	}

	public ValidationLconstraintException( String message )
	{
		super( message );
	}
